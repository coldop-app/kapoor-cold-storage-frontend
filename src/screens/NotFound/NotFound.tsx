...
const NotFound = () => {
  ...
  return (
    <>
      <SEO
        title={SEO_PAGES.NOT_FOUND.title}
        description={SEO_PAGES.NOT_FOUND.description}
        keywords={SEO_PAGES.NOT_FOUND.keywords}
        url={getPageUrl('/404')}
        noindex={SEO_PAGES.NOT_FOUND.noindex}
        nofollow={SEO_PAGES.NOT_FOUND.nofollow}
      />
      <motion.div
